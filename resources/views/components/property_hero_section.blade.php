    ...
    if(!empty($property->carousel_image) && !empty($property->carousel_image_mobile)){
        ...
        if(!empty($property->carousel_image)){ 
            $carousel_path = "images/carousel_images/".$property->carousel_image;
        } 

        if(!empty($property->carousel_image_mobile)){ 
            $carousel_mobile_path = "images/carousel_image_mobiles/".$property->carousel_image_mobile;
        } 
    ?>

    <section id="hero" class="hero-layout-five">
        <div class="hero-image">
                <img src="{{ asset($carousel_mobile_path) }}" class="hide-desktop " alt="{{$property->title}}" style="width:100%;">
                <img src="{{ asset($carousel_path) }}" alt="{{$property->title}}" class="mobile-hide" style="width:auto;">
        </div>
