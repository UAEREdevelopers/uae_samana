...
(function($) {
    ...
    jQuery.fn.menuzord = function(options) {
        ...
        if (settings.responsive) {
            $(menu_container).addClass("menuzord-responsive").prepend("");
        ...
        $.fn.scrollTo = function(f, g, h) { if (typeof g == 'object') { h = g;
            ...
            h.over = both(h.over); return this._scrollable().each(function() { if (f == null) return; var d = this,
                    ...
                    case 'string':
                        ...
                        targ = win ? $(targ) : $(targ, this); if (!targ.length) return;
                    case 'object':
                ...
                $.each(h.axis.split(''), function(i, a) { var b = a == 'x' ? 'Left' : 'Top',
                        ...
                        attr[key] += e[pos] || 0; if (h.over[pos]) attr[key] += targ[a == 'x' ? 'width' : 'height']() * h.over[pos] } else { var c = targ[pos];
